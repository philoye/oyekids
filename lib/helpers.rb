...
def flickr_embed_code(video,desired_width)
  ...
  %(<object type="application/x-shockwave-flash" data="#{video['source']}" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"> <param name="flashvars" value="flickr_show_info_box=false"></param> <param name="movie" value="#{video['source']}"></param><param name="bgcolor" value="#1b1b1b"></param><param name="allowFullScreen" value="true"></param><embed type="application/x-shockwave-flash" src="#{video['source']}" bgcolor="#1b1b1b" allowfullscreen="true" flashvars="flickr_show_info_box=false"></embed></object>)
end
